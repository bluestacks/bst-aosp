...
- Inventory entries: **1814**
- Existing files: **1813**
- Text lines: **1343325**
- Stages: `android16-promotion`=636, `aosp16-development`=840, `generated`=15, `reference`=45, `shared`=278
- Availability: `generated`=15, `local-only`=240, `removed-tombstone`=1, `repository`=1558
