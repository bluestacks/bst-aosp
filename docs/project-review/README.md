...
- Inventory entries: **1790**
- Existing files: **1789**
- Text lines: **1339209**
- Stages: `android16-promotion`=607, `aosp16-development`=845, `generated`=15, `reference`=45, `shared`=278
- Availability: `generated`=15, `local-only`=238, `removed-tombstone`=1, `repository`=1536
