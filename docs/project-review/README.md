...
- Inventory entries: **1821**
- Existing files: **1820**
- Text lines: **1347672**
- Stages: `android16-promotion`=642, `aosp16-development`=841, `generated`=15, `reference`=45, `shared`=278
- Availability: `generated`=15, `local-only`=238, `removed-tombstone`=1, `repository`=1567
