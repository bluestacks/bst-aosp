...
- Inventory entries: **1502**
- Existing files: **1501**
- Text lines: **721885**
- Stages: `android16-promotion`=550, `aosp16-development`=843, `generated`=15, `reference`=45, `shared`=49
- Availability: `generated`=15, `local-only`=1, `removed-tombstone`=1, `repository`=1485
- Findings: P2=1, P3=16
