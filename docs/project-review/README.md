...
- Inventory entries: **1807**
- Existing files: **1806**
- Text lines: **1341815**
- Stages: `android16-promotion`=618, `aosp16-development`=845, `generated`=15, `reference`=45, `shared`=284
- Availability: `generated`=15, `local-only`=238, `removed-tombstone`=1, `repository`=1553
