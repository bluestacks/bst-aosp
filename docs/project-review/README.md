...
- Inventory entries: **1791**
- Existing files: **1790**
- Text lines: **1339871**
- Stages: `android16-promotion`=608, `aosp16-development`=845, `generated`=15, `reference`=45, `shared`=278
- Availability: `generated`=15, `local-only`=238, `removed-tombstone`=1, `repository`=1537
