...
- Inventory entries: **1812**
- Existing files: **1811**
- Text lines: **1342849**
- Stages: `android16-promotion`=634, `aosp16-development`=840, `generated`=15, `reference`=45, `shared`=278
- Availability: `generated`=15, `local-only`=238, `removed-tombstone`=1, `repository`=1558
