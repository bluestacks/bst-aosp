...
- Inventory entries: **1793**
- Existing files: **1792**
- Text lines: **1340216**
- Stages: `android16-promotion`=610, `aosp16-development`=845, `generated`=15, `reference`=45, `shared`=278
- Availability: `generated`=15, `local-only`=238, `removed-tombstone`=1, `repository`=1539
