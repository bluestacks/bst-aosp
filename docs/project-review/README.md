...
- Inventory entries: **1789**
- Existing files: **1788**
- Text lines: **1338998**
- Stages: `android16-promotion`=602, `aosp16-development`=849, `generated`=15, `reference`=45, `shared`=278
- Availability: `generated`=15, `local-only`=241, `removed-tombstone`=1, `repository`=1532
