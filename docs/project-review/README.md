...
- Inventory entries: **1811**
- Existing files: **1810**
- Text lines: **1342484**
- Stages: `android16-promotion`=633, `aosp16-development`=840, `generated`=15, `reference`=45, `shared`=278
- Availability: `generated`=15, `local-only`=238, `removed-tombstone`=1, `repository`=1557
