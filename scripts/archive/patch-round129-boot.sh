#!/bin/bash
# Round 129: bs-odsign art-payload remount before odsign (R127/R128 art APEX gone @ odsign time)
set -e
AOSP=~/aosp16
...
echo "stage2 art-remount=$(grep -c 'henry-7BO art-remount' stage2.sh || true)"
