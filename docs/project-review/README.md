...
- Inventory entries: **1799**
- Existing files: **1798**
- Text lines: **1341306**
- Stages: `android16-promotion`=616, `aosp16-development`=845, `generated`=15, `reference`=45, `shared`=278
- Availability: `generated`=15, `local-only`=238, `removed-tombstone`=1, `repository`=1545
