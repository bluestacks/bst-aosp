...
- Existing files: **1788**
- Text lines: **1339087**
- Stages: `android16-promotion`=606, `aosp16-development`=845, `generated`=15, `reference`=45, `shared`=278
- Availability: `generated`=15, `local-only`=238, `removed-tombstone`=1, `repository`=1535
