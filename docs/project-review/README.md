...
- Inventory entries: **1798**
- Existing files: **1797**
- Text lines: **1341143**
- Stages: `android16-promotion`=615, `aosp16-development`=845, `generated`=15, `reference`=45, `shared`=278
- Availability: `generated`=15, `local-only`=238, `removed-tombstone`=1, `repository`=1544
